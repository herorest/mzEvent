...
var Zepto = function() {
    ...
    return B.matches = function(t, e) {
        ...
        var i, r, a;
        return Z.test(t) && (i = T(M.createElement(RegExp.$1))), i || (t.replace && (t = t.replace($, "<$1></$2>")), e === b && (e = _.test(t) && RegExp.$1), e in U || (e = "*"), a = U[e], a.innerHTML = "" + t, i = T.each(N.call(a.childNodes), function() {
            a.removeChild(this)
        ...
        if (!t) return B.Z();
        if ("string" == typeof t)
            if (t = t.trim(), "<" == t[0] && _.test(t)) i = B.fragment(t, RegExp.$1, n), t = null;
            else {
            ...
            else if (_.test(t)) i = B.fragment(t.trim(), RegExp.$1, n), t = null;
            else {
                if (n !== b) return T(n).find(t);
                i = B.qsa(M, t)
            }
        ...
        not: function(t) {
            ...
            if (e(t) && t.call !== b) this.each(function(e) {
                ...
                var i = "string" == typeof t ? this.filter(t) : a(t) && e(t.item) ? N.call(t) : T(t);
        ...
        closest: function(t, e) {
            var n = this[0],
                r = !1;
            for ("object" == typeof t && (r = T(t)); n && !(r ? r.indexOf(n) >= 0 : B.matches(n, t));) n = n !== e && !i(n) && n.parentNode;
            return T(n)
        },
        parents: function(t) {
        ...
        T.fn[e] = function() {
            ...
            return o.length < 1 ? this : this.each(function(t, e) {
                ...
                var s = T.contains(M.documentElement, r);
    ...
    }), B.Z.prototype = T.fn, B.uniq = C, B.deserializeValue = x, T.zepto = B, T
}();
    ...
    function(t) {
        ...
        S.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
            ...
            var v, x = r.accepts[p],
                ...
                T = r.xhr(),
                C = T.setRequestHeader;
            if (u && u.promise(T), r.crossDomain || b("X-Requested-With", "XMLHttpRequest"), b("Accept", x || "*/*"), (x = r.mimeType || x) && (x.indexOf(",") > -1 && (x = x.split(",", 2)[0]), T.overrideMimeType && T.overrideMimeType(x)), (r.contentType || r.contentType !== !1 && r.data && "GET" != r.type.toUpperCase()) && b("Content-Type", r.contentType || "application/x-www-form-urlencoded"), r.headers)
                for (g in r.headers) b(g, r.headers[g]);
            ...
            if (r.xhrFields)
                for (g in r.xhrFields) T[g] = r.xhrFields[g];
            var P = "async" in r ? r.async : !0;
            T.open(r.type, r.url, P, r.username, r.password);
            for (g in w) C.apply(T, w[g]);
    ...
    function(t, e) {
        ...
        t.each(m, function(t, n) {
            ...
            var v, w, b, E = {},
                ...
                C = !1;
            if (r === e && (r = t.fx.speeds._default / 1e3), g === e && (g = 0), t.fx.off && (r = 0), "string" == typeof i) E[l] = i, E[f] = r + "s", E[p] = g + "s", E[h] = d || "linear", S = t.fx.animationEnd;
            else {
                w = [];
